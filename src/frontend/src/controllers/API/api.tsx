import { IS_AUTO_LOGIN, LANGINFRA_ACCESS_TOKEN } from "@/constants/constants";
  ...
  useEffect(() => {
    ...
    const isAuthorizedURL = (url) => {
      const authorizedDomains = [
        "https://raw.githubusercontent.com/langinfra/langinfra_examples/main/examples",
        "https://api.github.com/repos/langinfra/langinfra_examples/contents/examples",
        "https://api.github.com/repos/langinfra/langinfra",
        "auto_login",
      ];
