...
from langinfra.interface.components import aget_all_types_dict
from langinfra.services.database.models import Flow
...
async def test_refresh_starter_projects():
    data_path = str(await Path(__file__).parent.parent.parent.absolute() / "base" / "langinfra" / "components")
...
@pytest.mark.parametrize(
    ...
    [
        (
            "https://github.com/langinfra/langinfra-bundles",
            "https://github.com/langinfra/langinfra-bundles/archive/refs/heads/main.zip",
        ),
        (
            "https://github.com/langinfra/langinfra-bundles/",
            "https://github.com/langinfra/langinfra-bundles/archive/refs/heads/main.zip",
        ...
        (
            "https://github.com/langinfra/langinfra-bundles.git",
            "https://github.com/langinfra/langinfra-bundles/archive/refs/heads/main.zip",
        ),
        (
            "https://github.com/langinfra/langinfra-bundles/tree/some.branch-0_1",
            "https://github.com/langinfra/langinfra-bundles/archive/refs/heads/some.branch-0_1.zip",
        ),
        (
            "https://github.com/langinfra/langinfra-bundles/tree/some/branch",
            "https://github.com/langinfra/langinfra-bundles/archive/refs/heads/some/branch.zip",
        ),
        (
            "https://github.com/langinfra/langinfra-bundles/tree/some/branch/",
            "https://github.com/langinfra/langinfra-bundles/archive/refs/heads/some/branch.zip",
        ...
        (
            "https://github.com/langinfra/langinfra-bundles/releases/tag/v1.0.0-0_1",
            "https://github.com/langinfra/langinfra-bundles/archive/refs/tags/v1.0.0-0_1.zip",
        ),
        (
            "https://github.com/langinfra/langinfra-bundles/releases/tag/foo/v1.0.0",
            "https://github.com/langinfra/langinfra-bundles/archive/refs/tags/foo/v1.0.0.zip",
        ),
        (
            "https://github.com/langinfra/langinfra-bundles/releases/tag/foo/v1.0.0/",
            "https://github.com/langinfra/langinfra-bundles/archive/refs/tags/foo/v1.0.0.zip",
        ...
        (
            "https://github.com/langinfra/langinfra-bundles/commit/68428ce16729a385fe1bcc0f1ec91fd5f5f420b9",
            "https://github.com/langinfra/langinfra-bundles/archive/68428ce16729a385fe1bcc0f1ec91fd5f5f420b9.zip",
        ),
        (
            "https://github.com/langinfra/langinfra-bundles/commit/68428ce16729a385fe1bcc0f1ec91fd5f5f420b9/",
            "https://github.com/langinfra/langinfra-bundles/archive/68428ce16729a385fe1bcc0f1ec91fd5f5f420b9.zip",
...
async def test_load_bundles_from_urls():
    ...
    try:
        ...
        assert "langinfra-bundles-68428ce16729a385fe1bcc0f1ec91fd5f5f420b9/components" in components_paths[0]
