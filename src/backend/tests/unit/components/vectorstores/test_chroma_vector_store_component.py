...
import pytest
from langinfra.components.vectorstores.chroma import ChromaVectorStoreComponent
...
class TestChromaVectorStoreComponent(ComponentTestBaseWithoutClient):
    ...
    def default_kwargs(self, tmp_path: Path) -> dict[str, Any]:
        ...
        from langinfra.components.embeddings.openai import OpenAIEmbeddingsComponent
    ...
    def test_mmr_search(self, component_class: type[ChromaVectorStoreComponent], default_kwargs: dict[str, Any]) -> None:
