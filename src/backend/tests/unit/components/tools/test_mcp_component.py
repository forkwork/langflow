...
import pytest
from langinfra.components.tools.mcp_component import MCPSseClient, MCPStdioClient, MCPToolsComponent
...
class TestMCPToolsComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("langinfra.components.tools.mcp_component.create_tool_coroutine")
