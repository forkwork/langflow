...
import pandas as pd
import pytest
from langinfra.components.processing.save_to_file import SaveToFileComponent
from langinfra.schema import Data, Message
...
class TestSaveToFileComponent(ComponentTestBaseWithoutClient):
    ...
    def test_save_message(self, component_class):
        ...
        for fmt, expected_content in test_cases:
            ...
            with patch("langinfra.components.processing.save_to_file.Path") as mock_path:
