...
from langinfra.initial_setup.setup import get_or_create_default_folder
...
def run(
    *,
    ...
    for key, value in os.environ.items():
        new_key = key.replace("LANGINFRA_", "")
...
def build_version_notice(current_version: str, package_name: str) -> str:
    ...
    Example:
        >>> build_version_notice("1.0.0", "langinfra")
        'A new version of langinfra is available: 1.1.0'
    """
