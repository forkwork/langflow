...
from langinfra.io import BoolInput, DropdownInput, HandleInput, IntInput, SecretStrInput, StrInput
...
class MongoVectorStoreComponent(LCVectorStoreComponent):
    ...
    inputs = [
        ...
        *LCVectorStoreComponent.inputs,
        ...
        StrInput(name="filter_field", display_name="Filter Field", advanced=True, info="The field to filter the index."),
        IntInput(
