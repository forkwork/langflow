...
class Settings(BaseSettings):
    ...
    """If True, Langinfra will retry to connect to the database if it fails."""
    pool_size: int = 20
    ...
    """If set to True, Langinfra will only partially load components at startup and fully load them on demand.
