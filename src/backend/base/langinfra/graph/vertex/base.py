...
from langinfra.graph.vertex.param_handler import ParameterHandler
...
from langinfra.utils.util import sync_to_async
...
class Vertex:
    ...
    async def build(
        ...
        **kwargs,
        ...
        from langinfra.interface.components import ensure_component_loaded
