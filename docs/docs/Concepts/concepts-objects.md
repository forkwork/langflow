...
Content types are Pydantic base classes constructed from the types in [content_types.py](https://github.com/langinfra-ai/langinfra/blob/main/src/backend/base/langinfra/schema/content_types.py).
